...
def selection_sort_name(students,records_per_row):
    ...
    for i in range(n//2):
        ...
        print("**********************************")
        for student in students:
            print("AdminNo: ",student.get_admin_no())
        print("**********************************")
    display_students(students,records_per_row)
...
def merge_sort_pem_group_admin_no(students):
    ...
    #Recursive case
        ...
        For example, when doing merge sort for [1,2,3,4,8,7,6,5], the mergelists function wont get called for sub arrays the first ever called left half of students.
        '''
